...
$(document).ready(function() {
  ...
  jQuery(".fake-ctrl").on("click", function(theEvent){
        //alert(theEvent.which);
        //var charCode = (evt.which) ? evt.which : event.keyCode;
        var charCode = (theEvent.which);
        var lastKey = jQuery("#roberto input").val();
        var lastChar = lastKey[lastKey.length -1];      
        checkAlternatives(lastChar);
  });
  ...
  jQuery("#course-inputlv").on("keyup", function(theEvent){
        ...
        if (charCode == 17) {
        checkAlternatives(lastChar);
        //alert('pressed Control');
        } else {
        counter = 0;
        replacementStatus = false; 
        //alert('nope it was '+theEvent.which);
        }
  });
...
/////////////////////////////////////////////////
//SA 12 June start Port CF code to courses-lowvision.js so may be used across site

      var replacementStatus = false;
      var counter = 0;
      var keyAlternatives = [//open keyAlternatives array
      ...
      function checkAlternatives (lastChar) {
        for (var i = 0; i < keyAlternatives.length; i++) {
          var thingToCheck = !replacementStatus ? lastChar : replacementStatus;
          console.log('thing to check ' + thingToCheck);
          if (thingToCheck == keyAlternatives[i][0]) {
            replacementStatus = thingToCheck;
            var str = jQuery("#roberto input").val();
            var res = str.substring(jQuery("#roberto input").val(), jQuery("#roberto input").val().length-1);
            console.log ('replacement: ' + keyAlternatives[i][1][counter]);
            jQuery("#roberto input").val(res + keyAlternatives[i][1][counter]);
            counter = counter < keyAlternatives[i][1].length-1 ? counter + 1 : 0;
          }
        }
      }
...
//SA 12 June end Port CF code to courses-lowvision.js so may be used across site
///////////////////////////////////////////////
  /*
//////////////////////////////////////////////////////////////////////////////
